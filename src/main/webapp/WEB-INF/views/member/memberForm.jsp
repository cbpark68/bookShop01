...
function fn_compare_pwd(){
	...
	if(pwd1 == pwd2){
		compare_result = true;
		$('#s_result').text("비번이 일치합니다.");
	}else{
		compare_result = false;
		$('#s_result').text("비번이 일치하지 않습니다.");
	}
}
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td><input name="member_pw2" id="member_pw2" type="password" size="20" onkeyup="fn_compare_pwd();"/>
					<span style="font-size:10px;" id="s_result">비번이 일치하지 않습니다.</span></td>
				</tr>
				<tr class="dot_line">
